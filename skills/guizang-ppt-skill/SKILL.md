...
# 风格 A · 电子杂志风
cp "{baseDir}/assets/template.html" "项目/XXX/ppt/index.html"

# 或 风格 B · 瑞士国际主义风
cp "{baseDir}/assets/template-swiss.html" "项目/XXX/ppt/index.html"
```
...
- 开写 HTML 前先列一张 `页码 → data-layout → 选用理由 → 图片槽位` 草稿;交付前运行 `node {baseDir}/scripts/validate-swiss-deck.mjs index.html`。
