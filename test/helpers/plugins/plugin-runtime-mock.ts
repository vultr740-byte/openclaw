...
export function createPluginRuntimeMock(overrides: DeepPartial<PluginRuntime> = {}): PluginRuntime {
  ...
  const base: PluginRuntime = {
    ...
    channel: {
      ...
      activity: {
        record: vi.fn() as unknown as PluginRuntime["channel"]["activity"]["record"],
        get: vi.fn() as unknown as PluginRuntime["channel"]["activity"]["get"],
      },
      session: {
        resolveStorePath: vi.fn(
          () => "/tmp/sessions.json",
      ...
      discord: {
        messageActions: vi.fn() as unknown as PluginRuntime["channel"]["discord"]["messageActions"],
        auditChannelPermissions:
          vi.fn() as unknown as PluginRuntime["channel"]["discord"]["auditChannelPermissions"],
        listDirectoryGroupsLive:
          vi.fn() as unknown as PluginRuntime["channel"]["discord"]["listDirectoryGroupsLive"],
        listDirectoryPeersLive:
          vi.fn() as unknown as PluginRuntime["channel"]["discord"]["listDirectoryPeersLive"],
        probeDiscord: vi.fn() as unknown as PluginRuntime["channel"]["discord"]["probeDiscord"],
        resolveChannelAllowlist:
          vi.fn() as unknown as PluginRuntime["channel"]["discord"]["resolveChannelAllowlist"],
        resolveUserAllowlist:
          vi.fn() as unknown as PluginRuntime["channel"]["discord"]["resolveUserAllowlist"],
        sendMessageDiscord:
          vi.fn() as unknown as PluginRuntime["channel"]["discord"]["sendMessageDiscord"],
        sendPollDiscord:
          vi.fn() as unknown as PluginRuntime["channel"]["discord"]["sendPollDiscord"],
        monitorDiscordProvider:
          vi.fn() as unknown as PluginRuntime["channel"]["discord"]["monitorDiscordProvider"],
      },
      slack: {
        listDirectoryGroupsLive:
          vi.fn() as unknown as PluginRuntime["channel"]["slack"]["listDirectoryGroupsLive"],
        listDirectoryPeersLive:
          vi.fn() as unknown as PluginRuntime["channel"]["slack"]["listDirectoryPeersLive"],
        probeSlack: vi.fn() as unknown as PluginRuntime["channel"]["slack"]["probeSlack"],
        resolveChannelAllowlist:
          vi.fn() as unknown as PluginRuntime["channel"]["slack"]["resolveChannelAllowlist"],
        resolveUserAllowlist:
          vi.fn() as unknown as PluginRuntime["channel"]["slack"]["resolveUserAllowlist"],
        sendMessageSlack:
          vi.fn() as unknown as PluginRuntime["channel"]["slack"]["sendMessageSlack"],
        monitorSlackProvider:
          vi.fn() as unknown as PluginRuntime["channel"]["slack"]["monitorSlackProvider"],
        handleSlackAction:
          vi.fn() as unknown as PluginRuntime["channel"]["slack"]["handleSlackAction"],
      },
      telegram: {
        auditTelegramGroupMembership:
          vi.fn() as unknown as PluginRuntime["channel"]["telegram"]["auditTelegramGroupMembership"],
        collectTelegramUnmentionedGroupIds:
          vi.fn() as unknown as PluginRuntime["channel"]["telegram"]["collectTelegramUnmentionedGroupIds"],
        probeTelegram: vi.fn() as unknown as PluginRuntime["channel"]["telegram"]["probeTelegram"],
        resolveTelegramToken:
          vi.fn() as unknown as PluginRuntime["channel"]["telegram"]["resolveTelegramToken"],
        sendMessageTelegram:
          vi.fn() as unknown as PluginRuntime["channel"]["telegram"]["sendMessageTelegram"],
        sendPollTelegram:
          vi.fn() as unknown as PluginRuntime["channel"]["telegram"]["sendPollTelegram"],
        monitorTelegramProvider:
          vi.fn() as unknown as PluginRuntime["channel"]["telegram"]["monitorTelegramProvider"],
        messageActions:
          vi.fn() as unknown as PluginRuntime["channel"]["telegram"]["messageActions"],
      },
      signal: {
        probeSignal: vi.fn() as unknown as PluginRuntime["channel"]["signal"]["probeSignal"],
        sendMessageSignal:
          vi.fn() as unknown as PluginRuntime["channel"]["signal"]["sendMessageSignal"],
        monitorSignalProvider:
          vi.fn() as unknown as PluginRuntime["channel"]["signal"]["monitorSignalProvider"],
        messageActions: vi.fn() as unknown as PluginRuntime["channel"]["signal"]["messageActions"],
      },
      imessage: {
        monitorIMessageProvider:
          vi.fn() as unknown as PluginRuntime["channel"]["imessage"]["monitorIMessageProvider"],
        probeIMessage: vi.fn() as unknown as PluginRuntime["channel"]["imessage"]["probeIMessage"],
        sendMessageIMessage:
          vi.fn() as unknown as PluginRuntime["channel"]["imessage"]["sendMessageIMessage"],
      },
      whatsapp: {
        getActiveWebListener:
          vi.fn() as unknown as PluginRuntime["channel"]["whatsapp"]["getActiveWebListener"],
        getWebAuthAgeMs:
          vi.fn() as unknown as PluginRuntime["channel"]["whatsapp"]["getWebAuthAgeMs"],
        logoutWeb: vi.fn() as unknown as PluginRuntime["channel"]["whatsapp"]["logoutWeb"],
        logWebSelfId: vi.fn() as unknown as PluginRuntime["channel"]["whatsapp"]["logWebSelfId"],
        readWebSelfId: vi.fn() as unknown as PluginRuntime["channel"]["whatsapp"]["readWebSelfId"],
        webAuthExists: vi.fn() as unknown as PluginRuntime["channel"]["whatsapp"]["webAuthExists"],
        sendMessageWhatsApp:
          vi.fn() as unknown as PluginRuntime["channel"]["whatsapp"]["sendMessageWhatsApp"],
        sendPollWhatsApp:
          vi.fn() as unknown as PluginRuntime["channel"]["whatsapp"]["sendPollWhatsApp"],
        loginWeb: vi.fn() as unknown as PluginRuntime["channel"]["whatsapp"]["loginWeb"],
        startWebLoginWithQr:
          vi.fn() as unknown as PluginRuntime["channel"]["whatsapp"]["startWebLoginWithQr"],
        waitForWebLogin:
          vi.fn() as unknown as PluginRuntime["channel"]["whatsapp"]["waitForWebLogin"],
        monitorWebChannel:
          vi.fn() as unknown as PluginRuntime["channel"]["whatsapp"]["monitorWebChannel"],
        handleWhatsAppAction:
          vi.fn() as unknown as PluginRuntime["channel"]["whatsapp"]["handleWhatsAppAction"],
        createLoginTool:
          vi.fn() as unknown as PluginRuntime["channel"]["whatsapp"]["createLoginTool"],
      },
      line: {
        listLineAccountIds:
          vi.fn() as unknown as PluginRuntime["channel"]["line"]["listLineAccountIds"],
        resolveDefaultLineAccountId:
          vi.fn() as unknown as PluginRuntime["channel"]["line"]["resolveDefaultLineAccountId"],
        resolveLineAccount:
          vi.fn() as unknown as PluginRuntime["channel"]["line"]["resolveLineAccount"],
        normalizeAccountId:
          vi.fn() as unknown as PluginRuntime["channel"]["line"]["normalizeAccountId"],
        probeLineBot: vi.fn() as unknown as PluginRuntime["channel"]["line"]["probeLineBot"],
        sendMessageLine: vi.fn() as unknown as PluginRuntime["channel"]["line"]["sendMessageLine"],
        pushMessageLine: vi.fn() as unknown as PluginRuntime["channel"]["line"]["pushMessageLine"],
        pushMessagesLine:
          vi.fn() as unknown as PluginRuntime["channel"]["line"]["pushMessagesLine"],
        pushFlexMessage: vi.fn() as unknown as PluginRuntime["channel"]["line"]["pushFlexMessage"],
        pushTemplateMessage:
          vi.fn() as unknown as PluginRuntime["channel"]["line"]["pushTemplateMessage"],
        pushLocationMessage:
          vi.fn() as unknown as PluginRuntime["channel"]["line"]["pushLocationMessage"],
        pushTextMessageWithQuickReplies:
          vi.fn() as unknown as PluginRuntime["channel"]["line"]["pushTextMessageWithQuickReplies"],
        createQuickReplyItems:
          vi.fn() as unknown as PluginRuntime["channel"]["line"]["createQuickReplyItems"],
        buildTemplateMessageFromPayload:
          vi.fn() as unknown as PluginRuntime["channel"]["line"]["buildTemplateMessageFromPayload"],
        monitorLineProvider:
          vi.fn() as unknown as PluginRuntime["channel"]["line"]["monitorLineProvider"],
      },
    },
    events: {
